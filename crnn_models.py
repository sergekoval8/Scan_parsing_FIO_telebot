...
class ImgTextData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        transform_tr = transforms.Compose([
                                           transforms.RandomAffine(3, scale=(0.8, 1.03), fill=bg),
...
class CRNN(CRNN_PRO):
    def __init__(self, chars, blank=0, img_h=32, img_w=340, gru_hidden_size=128, gru_num_layers=2):
        super().__init__()
        self.IMG_H = img_h
        self.IMG_W = img_w
        self.CHARS = chars
...
if __name__ == '__main__':
    ...
    results = {"train_acc": [], "val_acc": [], "train_loss": [], "val_loss": [], "lr": []}
